...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SABLEManager",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC12SABLEManager12SABleManager")
@interface SABleManager : NSObject
...
@interface SABleManager (SWIFT_EXTENSION(SABLEManager)) <CBPeripheralDelegate>
...
@interface SABleManager (SWIFT_EXTENSION(SABLEManager)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC12SABLEManager6SAPeer")
@interface SAPeer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12SABLEManager19SAPeripheralManager")
@interface SAPeripheralManager : SAPeer
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface SAPeripheralManager (SWIFT_EXTENSION(SABLEManager)) <CBPeripheralManagerDelegate>
